...
--changeset liquibase:12 pass alice -> 529

INSERT INTO user_info (info_id, firstname, lastname, email, phone_number, username, password, updated_at)
VALUES (UUID_TO_BIN(UUID()), 'Alice', 'Smith', 'alice@example.com', '111222333', 'alice',
        '$2a$12$mUHd9lrvRaB.qehTJz3x5eD7AmaxjVgfndtQfiJxb/9Ab///GVVNW', NOW()),
