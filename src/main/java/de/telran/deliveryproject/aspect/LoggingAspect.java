package de.telran.deliveryproject.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * de.telran.deliveryproject.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * de.telran.deliveryproject.service.*.*(..))")
