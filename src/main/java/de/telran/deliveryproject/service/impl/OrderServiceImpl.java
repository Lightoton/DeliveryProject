...
public class OrderServiceImpl implements OrderService {
    ...
    public Order createOrder(Order order, String restaurantId, String clientId, String supportManagerId,
        ...
        Courier courier = courierRepository.findById(UUID.fromString(courierId))
        ...
        SupportManager supportManager = managerRepository.findById(UUID.fromString(supportManagerId))
        ...
        Department department = departmentRepository.findById(UUID.fromString(departmentId))
                .orElseThrow(() -> new DepartmentNotFoundException(ErrorMessage.DEPARTMENT_NOT_FOUND));
