...
VALUES (X'c80d54d3500d453994798e8961477193', 'Alice', 'Smith', 'alice@example.com', '111222333', 'alice',
        '$2a$12$mUHd9lrvRaB.qehTJz3x5eD7AmaxjVgfndtQfiJxb/9Ab///GVVNW', CURRENT_TIMESTAMP),
...
VALUES (CAST('61954128-24ff-457b-8731-fd4a234ddc45' as binary(16)), 'Green Leaf Cafe', '123 Main Street, Cityville',
        NOW(),
...
VALUES (CAST('59c04fb7-2182-413e-acda-7438fa448757' as binary(16)), 'Salads', NOW(),
        (select menu_id from menu where menu.title = 'Healthy Choices')),
...
VALUES (CAST('cb9bdf6e-3488-4437-92d2-37e34361e5fb' as binary(16)), 'Grilled Chicken Salad', 350, 12.99,
        '2024-03-12 12:00:00', NOW(),
...
VALUES ((SELECT info_id FROM user_info WHERE username = 'alice'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_CLIENT')),
       ((SELECT info_id FROM user_info WHERE username = 'bob'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_CLIENT')),
       ((SELECT info_id FROM user_info WHERE username = 'charlie'),
        (SELECT role_id FROM roles WHERE role_name = 'ROLE_CLIENT')),
       ((SELECT info_id FROM user_info WHERE username = 'emily'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_CLIENT')),
       ((SELECT info_id FROM user_info WHERE username = 'david'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_CLIENT')),
...
VALUES (CAST('bef076d4-9a54-49bd-bdb8-6cd0615bfbf5' as binary(16)), '1990-01-01', 'STAR5', '123 Main Street',
        '2024-03-25',
...
VALUES (UUID(), 5, (select o_id from orders where status_order = 'AWAITING_PAYMENT'),
        (select f_id from foods where title = 'Grilled Chicken Salad')),
       (uuid(), 2, (select o_id from orders where status_order = 'AWAITING_PAYMENT'),
        (select f_id from foods where title = 'Vegetarian Salad'));

INSERT INTO couriers (c_id, rating, status_courier, salary, status_employee, hire_date, user_info_id, order_id,
                      department_id)
VALUES (CAST('286abd49-a85b-4fc2-9c31-8fdcc5d42782' as binary(16)), 'STAR7', 'FREE', 2500.00, 'WORK',
        '2023-01-15 08:00:00',
        (SELECT info_id FROM user_info WHERE username = 'michael'),
